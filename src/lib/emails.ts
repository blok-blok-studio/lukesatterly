 ...
 * Multipart (HTML + text) significantly improves deliverability — HTML-only
 * messages are commonly flagged as promotional or spam.
 *
...
export function welcomeEmail(
  ...
  const extraText =
    timeline === "Ready to start now"
      ? `You mentioned you're ready to start — if you want hands-on coaching where I build everything around you specifically, let's talk: ${SITE_URL}/start`
  ...
  const html = layoutHtml(
    ...
    ${buttonHtml("Download Your Template", "https://linktr.ee/coachluki")}
    <p style="line-height: 1.7;">
...
<html lang="en">
  <body style="margin:0; padding:0; background:#f6f6f4;">
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #333; background:#ffffff;">
      ...
      ${buttonHtml("Book a call", "https://calendar.google.com/calendar/appointments/schedules/AcZssZ2v3xRsZStR2Wtk8dr_F8kwEq4WGWu0FM548fk45LXMHonM5FwIUFHmuTTp0Ph6eVpcM1ZeM2PC")}
      <p style="line-height: 1.7;">
...
In the meantime, if you want to book a call directly, you can pick a time here: https://calendar.google.com/calendar/appointments/schedules/AcZssZ2v3xRsZStR2Wtk8dr_F8kwEq4WGWu0FM548fk45LXMHonM5FwIUFHmuTTp0Ph6eVpcM1ZeM2PC
